...
/**
 * Port of resources/views/layouts/auth-branded.blade.php.
 *
 * Markup, class names, copy, inline SVGs and image paths are reproduced
 * exactly. The Blade version guarded each image with file_exists() and fell
 * back when missing; the files are present in public/ and ship with the
 * repo, so they are referenced directly — Next serves public/ at the root,
 * which makes the old asset() paths valid unchanged.
 */
export default function AuthBrandedLayout({ children }: { children: ReactNode }) {
  return (
    <div className="tdms-auth">
      <div className="tdms-auth__main">
        <section
          className="tdms-auth__hero"
          style={{ '--tdms-campus-image': "url('/images/auth/campus.jpg')" } as React.CSSProperties}
        >
          ...
          <div className="hero__cards">
            <div className="program-card">
              ...
              <div className="program-card__media program-card__media--hospitality">
                ...
                <img
                  src="/images/auth/hospitality-student.jpg"
                  alt="Hospitality Technology student at the training bar"
                />
              </div>
            </div>
            ...
            <div className="program-card">
              ...
              <div className="program-card__media program-card__media--it">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img
                  src="/images/auth/it-student.jpg"
                  alt="Information Technology student in the computer laboratory"
                />
              </div>
            </div>
          </div>
          ...
          <div className="panel__card">
            <div className="panel__logo-wrap">
              ...
              <img
                ...
                alt="Asian College Diploma Program Department logo"
