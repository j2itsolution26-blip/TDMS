 ...
 * this is the direct TypeScript port of
 * database/seeders/RolesAndPermissionsSeeder.php in the Laravel app,
 * and must be kept in sync with it by hand until the Laravel app is
 * fully retired.
 *
